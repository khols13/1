...
cl = LINETCR.LINE()
cl.login(token="EoKp9AzeHmFRRb9vMXf7.vRkykT/S5RsMsiwWlC435W.t64iG1MIGcMHD332PsKbGUOiOaLdPaafiSksmx28Oz0=")
cl.loginResult()
...
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,"u56b2982adface6b4a64885b02dce37e7"]
admsa = "u56b2982adface6b4a64885b02dce37e7"
admin = "u56b2982adface6b4a64885b02dce37e7"
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "---------------\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n---------------\nIn the last seen point:\n[%s]\n---------------\n Powered By: Khols R. Perkasa" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
